...
import loginImage from "../../src/assets/LoginScreenMailBox.png";
const Register = () => {
  ...
  const handleSubmit = (e) => {
    ...
    setLoading(true);
    fetch(
      "https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyDrobXOObSkmYJNeIvX4mX6QZxiw4L7EXE",
      {
        method: "POST",
        body: JSON.stringify({
          email: data.email,
