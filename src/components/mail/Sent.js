  ...
  return (
    <Link to="/sent">
      <div className="flex flex-col flex-1 overflow-hidden">
        <main className="flex-1 overflow-x-hidden overflow-y-auto bgColor">
          <div className=" container left-17rem mx-auto px-6 py-8 top-0 w-[70%]">
            <h1 className="inboxHeading">Sent Items</h1>
